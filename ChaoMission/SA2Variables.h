...
DataPointer(eCHAO_STAGE_NUMBER, LastChaoArea, 0x13402AC);
DataPointer(eCHAO_STAGE_NUMBER, CurrentChaoArea, 0x134046C);
DataPointer(eCHAO_STAGE_NUMBER, NextChaoArea, 0x134062C);
...
DataArray(NJS_POINT3, ChaoSetPositionNeut, 0x01366260, 16);          
DataArray(NJS_POINT3, ChaoSetPositionHero, 0x01366320, 16);          
DataArray(NJS_POINT3, ChaoSetPositionDark, 0x013663E0, 16);          
